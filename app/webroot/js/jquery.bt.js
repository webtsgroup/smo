...
;(function($) { 
  ...
  */
  ...
  jQuery.bt.defaults = {
    ...
    padding:          '8px 12px',                // padding for content (get more fine grained with cssStyles)
    spikeGirth:       14,                    // width of spike
    spikeLength:      6,                    // length of spike
    ...
    fill:             "rgba(0, 0, 0, .8)",  // fill color for the tooltip box, you can use any CSS-style color definition method
    ...
    cornerRadius:     3,                     // radius of corners (px), set to 0 for square corners
    ...
    cssStyles:        {color: 'white', fontWeight: 'bold', fontSize: '11px', lineHeight: '15px'},                    // styles to add the text box
