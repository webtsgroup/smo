...
<section id="main-content">
  <section class="wrapper">
    ...
    <div class="box-header">
        <h3 class="box-title"><i class="glyphicon glyphicon-list"></i> <?php echo __('Account Lists',true);?>
        <div class="pull pull-right">
            <a class="btn btn-sm btn-success" href="<?php echo $this->Html->url(array('action' => 'add')); ?>" ><i class="glyphicon glyphicon-plus"></i> 
...
<div id="action-template" style="display: none;">
    ...
    <a class="btn btn-default btn-xs" role="deleteItem" title="<?php echo __('Suspend',true);?>" href="javascript:;">
...
<script type="text/javascript">
	(function($){   
        $(function(){
            ...
            $this.init($('#dataviewContainer'),data,columns);
        });
    })(jQuery);
</script>   