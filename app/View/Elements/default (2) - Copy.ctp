...
<html lang="en">
  <head>
	...
	echo $this->Html->script('chart-master/Chart.js');
	?>    
  ...
  <section id="container" >
	...
	<?php
		...
		echo $this->Html->script(array(
			...
			'jquery.gritter', //common script for all pages
			'gritter-conf', //common script for all pages
		));
		echo $this->Html->script(array(
			'sparkline-chart', //script for this page
			'zabuto_calendar' //script for this page
		));
	?>		
